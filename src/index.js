...
function generateJoke(event) {
  ...
  let context =
    "You are a funny joke expert and love to tell funny jokes. Your mission is to generate a joke in basic HTMl and separate each line with a <br />. Do not include a title to the joke. Sign the poem with 'SheCodes AI' inside a <strong> element at the end of the joke and NOT at the beginning. Make sure to follow the user intructions.";
